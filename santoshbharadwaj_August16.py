...
print(a + 5) # Error sequence and non sequence cannot be added
print(a + '5') # error can only concatenate list to list
print([10 , 20] + (30 , 40)) # error can only concatenate list to list
...
list = [25 , 10.8 , 'Hyd' , True , 3 + 4j]
a , *b , c , *d , e  = list # multiple star assignment
